...
<div class="container-fluid">
    ...
    <div>
    <div class="text-value-lg">{{ number_format($settings1['total_number']) }}</div>
    ...
    <canvas class="chart chartjs-render-monitor" id="card-chart1" height="210" style="display: block; width: 296px; height: 70px;" width="888"></canvas>
    </div>
    </div>
    </div>
    ...
    <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
    <canvas class="chart chartjs-render-monitor" id="card-chart2" height="210" width="888" style="display: block; width: 296px; height: 70px;"></canvas>
    </div>
    </div>
    </div>
    ...
    <canvas class="chart chartjs-render-monitor" id="card-chart3" height="210" width="984" style="display: block; width: 328px; height: 70px;"></canvas>
    </div>
    </div>
    </div>
    ...
    <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
    <canvas class="chart chartjs-render-monitor" id="card-chart4" height="210" width="888" style="display: block; width: 296px; height: 70px;"></canvas>
    </div>
    </div>
    </div>
    ...
    <canvas class="chart chartjs-render-monitor" id="main-chart" height="900" width="864" style="display: block; width: 288px; height: 300px;"></canvas>
    </div>
    </div>
    ...
    <td class="text-center">
    <svg class="c-icon c-icon-xl">
    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-cc-app c-legacy-themele-pay"></use>
    </svg>
    </td>
    <td>
