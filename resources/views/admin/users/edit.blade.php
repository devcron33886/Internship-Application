    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('department') ? 'is-invalid' : '' }}" type="text" name="department" id="department" value="{{ old('department', $user->department) }}" required>
            ...
            <div class="form-group">
                <label class="required" for="option">{{ trans('cruds.user.fields.option') }}</label>
                <input class="form-control {{ $errors->has('option') ? 'is-invalid' : '' }}" type="text" name="option" id="option" value="{{ old('option', $user->option) }}" required>
                @if($errors->has('option'))
                    <div class="invalid-feedback">
                        {{ $errors->first('option') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.option_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required">{{ trans('cruds.user.fields.sex') }}</label>
                @foreach(App\Models\User::SEX_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('sex') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="sex_{{ $key }}" name="sex" value="{{ $key }}" {{ old('sex', $user->sex) === (string) $key ? 'checked' : '' }} required>
