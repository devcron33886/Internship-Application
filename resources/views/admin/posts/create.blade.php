        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.posts.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('positions') ? 'is-invalid' : '' }}" type="number" name="positions" id="positions" value="{{ old('positions', '') }}" step="1" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('opening_date') ? 'is-invalid' : '' }}" type="text" name="opening_date" id="opening_date" value="{{ old('opening_date') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('closing_date') ? 'is-invalid' : '' }}" type="text" name="closing_date" id="closing_date" value="{{ old('closing_date') }}" required>
